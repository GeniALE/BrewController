...
public class Startup
{
    public static void ConfigureServices(IServiceCollection services)
    {
        var mongodbConnectionString =
            Environment.GetEnvironmentVariable("BREW_DB_URI") ?? "mongodb://root:pass@localhost";
        ...
        app
            ...
            .UseEndpoints(endpoints =>
            {
                endpoints.MapGraphQL()
                    ...
                    {
                        Tool = { Enable = env.IsDevelopment(), DisableTelemetry = true, },
                    });
            });
        ...
        app
            .UseEndpoints(endpoints =>
            {
                endpoints.MapFallbackToFile("/index.html",
                    new StaticFileOptions { FileProvider = new PhysicalFileProvider(appDir), RequestPath = "", });
            });
        app.UseFileServer(new FileServerOptions
        {
            FileProvider = new PhysicalFileProvider(appDir), RequestPath = "",
        });
    }
}